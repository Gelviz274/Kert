  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'page_view', {
        ...
        send_to: 'G-5Q54M6CDKM'
      });
      
      window.gtag('event', 'error', {
        'event_category': 'Error',
        'event_label': `404 - ${window.location.pathname}`,
      ...
      <div className="min-h-screen bg-azul relative overflow-hidden">
        ...
        <div className="relative min-h-screen flex items-center justify-center p-6">
          <div className="max-w-3xl w-full">
              ...
              <div className="text-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 pt-4">
                  <Link
                    ...
                    <button
                      className="group inline-flex items-center px-8 py-4 bg-amarillo text-azul rounded-xl font-semibold transition-all duration-300 hover:bg-[#FFD633] hover:shadow-[0_0_30px_rgba(255,207,0,0.3)] transform hover:-translate-y-1"
                    >
                  ...
                  <Link
                    href="/coleccion"
                    aria-label="Ver nuestro catálogo de productos">
                    <button
            ...
            {/* Footer with sitemap links for SEO */}
            <div className="text-center mt-8">
              <p className="text-white/60 text-sm">
                ¿Necesitas ayuda? <Link href="/contacto" className="text-amarillo hover:underline" aria-label="Contacta con nuestro equipo">Contacta con nosotros</Link>
              </p>
              
              <div className="mt-4 flex flex-wrap justify-center gap-4 text-xs text-white/40">
                <Link href="/" className="hover:text-amarillo">Inicio</Link>
                <Link href="/coleccion" className="hover:text-amarillo">Colección</Link>
                <Link href="/coleccion/maletas" className="hover:text-amarillo">Maletas</Link>
                <Link href="/coleccion/rinoneras" className="hover:text-amarillo">Riñoneras</Link>
                <Link href="/sobre-nosotros" className="hover:text-amarillo">Sobre Nosotros</Link>
                <Link href="/contacto" className="hover:text-amarillo">Contacto</Link>
              </div>
            </div>
          </div>
        </div>
