...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://creacionkert.com/coleccion/bolsas-tela/${nameTitle}`,
      type: "website",
      locale: "es_CO",
      siteName: "Kert S.A.S",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Bolsas en Tela", "item": "https://creacionkert.com/coleccion/bolsas-tela" },
              { "@type": "ListItem", "position": 4, "name": producto.name, "item": `https://creacionkert.com/coleccion/bolsas-tela/${nameTitle}` },
            ],
          }),
        }}
      />
