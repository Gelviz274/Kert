...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.creacionkert.com/coleccion/bolsas-tela/${nameTitle}`,
    },
    openGraph: {
      title: producto ? `${producto.name} | Kert S.A.S - Bolsas en Tela al Por Mayor` : 'Producto no encontrado',
      ...
      url: `https://www.creacionkert.com/coleccion/bolsas-tela/${nameTitle}`,
      type: "website",
      locale: "es_CO",
      siteName: "Kert S.A.S",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Bolsas en Tela", "item": "https://www.creacionkert.com/coleccion/bolsas-tela" },
              { "@type": "ListItem", "position": 4, "name": producto.name, "item": `https://www.creacionkert.com/coleccion/bolsas-tela/${nameTitle}` },
            ],
          }),
        }}
      />
