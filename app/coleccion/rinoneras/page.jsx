...
function RinonerasPage() {
  ...
  const [filteredRinoneras, setFilteredRinoneras] = useState(rinonerasData.rinoneras);
  ...
  useEffect(() => {
    const results = rinonerasData.rinoneras.filter(rinonera =>
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Descubre nuestra exclusiva selección de riñoneras diseñadas para combinar estilo, durabilidad y funcionalidad.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="relative bg-white/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <input
                type="text"
                placeholder="Buscar riñoneras por nombre..."
                value={searchTerm}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-azul">
              <span className="border-b-4 border-amarillo pb-2">Nuestras Riñoneras</span>
            </h2>
          </motion.div>
          
          {filteredRinoneras.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-xl text-gray-600">No se encontraron rinoneras que coincidan con tu búsqueda.</p>
              <button 
              ...
              {filteredRinoneras.map((rinonera) => (
                ...
                >
                  ...
                  <div className="p-8 relative">
                    ...
                    <div className="mb-6">
                      <h3 className="text-2xl font-bold text-azul mb-2">{rinonera.name}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                      <div className="bg-gray-50 rounded-xl p-4 text-center">
                        ...
                        <p className="text-lg font-bold text-azul">{rinonera.minOrder}</p>
                      </div>
                      <div className="bg-gray-50 rounded-xl p-4 text-center">
                        <p className="text-sm text-gray-500 mb-1">Pedido máximo</p>
                        <p className="text-lg font-bold text-azul">{rinonera.maxOrder}</p>
                      </div>
                    </div>
                    <Link href={`/coleccion/rinoneras/${rinonera['name-title']}`} className="block">
