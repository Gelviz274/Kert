...
function NecesersPage() {
  const [searchTerm, setSearchTerm] = useState('');
  const [filteredNecesers, setFilteredNecesers] = useState(neceserData.necesers);
  ...
  // Filtrar neceseres basado en la búsqueda
  useEffect(() => {
    const results = neceserData.necesers.filter(neceser =>
      neceser.name.toLowerCase().includes(searchTerm.toLowerCase())
    );
    setFilteredNecesers(results);
  }, [searchTerm]);
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Descubre nuestra exclusiva selección de neceseres diseñados para combinar estilo, durabilidad y funcionalidad.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="relative bg-white/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <input
                type="text"
                placeholder="Buscar neceseres por nombre..."
                value={searchTerm}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-azul">
              <span className="border-b-4 border-amarillo pb-2">Nuestros Neceseres</span>
            </h2>
          </motion.div>
          
          {filteredNecesers.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-xl text-gray-600">No se encontraron neceseres que coincidan con tu búsqueda.</p>
              <button 
