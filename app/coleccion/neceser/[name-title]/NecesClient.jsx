...
import { Briefcase, Ruler, Info, ShoppingBag } from "lucide-react";
import Image from "next/image";

function NecesClient({ neceser }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="aspect-square rounded-lg overflow-hidden bg-white shadow-lg">
              <Image
                src={neceser.images[selectedImage]}
                alt={neceser.name}
                width={900}
                height={900}
            ...
            <div className="flex gap-4">
              {neceser.images.map((image, index) => (
                <button
                  key={index}
                ...
                >
                  <img
                    src={image}
                    alt={`${neceser.name} vista ${index + 1}`}
                    className="w-full h-full object-cover"
                  />
                </button>
              ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                {neceser.specifications.map((spec, index) => (
