...
const bags = [
  {
    ...
    specifications: [
      ...
      "Bolsillo frontal",
      "Cargadera con malla sándwich y Yumbolon",
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4">
              {selectedBag.images.map((image, index) => (
                <button
                  ...
                  className={`w-20 h-20 rounded-lg overflow-hidden ${selectedImage === index ? 'ring-2 ring-amarillo' : ''
                    }`}
                >
                  <img
                    src={image}
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl font-bold text-azul">{selectedBag.name}</h2>
            ...
            <div className="bg-amarillo p-4 rounded-lg shadow-md text-center">
              <p className="text-lg font-semibold text-azul mb-3">¿Quieres hacer un pedido?</p>
