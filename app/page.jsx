...
export default function Home() {
  return (
    <>
      <div className="flex text-white bg-azul w-full h-auto m-0">
        <Carrusel />
      </div>
      <section className="bg-gray-50 w-full py-16 flex flex-col items-center">
  <div className="max-w-7xl w-full px-6 md:px-12 flex flex-col md:flex-row gap-10 items-center">
    ...
    <div className="w-full md:w-1/2 flex flex-col gap-6">
      <h1 className="text-4xl font-bold text-gray-900">Sobre Kert</h1>
  ...
  <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 px-6">
    {[
