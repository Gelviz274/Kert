...
const components = [
  {
    ...
    href: "/coleccion",
    description: "Mira toda nuestra colección de productos, especialmente diseñada para ti.",
  },
  {
    ...
    description:
      "Diseñadas para ofrecer durabilidad y estilo, ideales para viajes largos o cortos.",
  },
  {
    icon: Briefcase,
    title: "Riñoneras",
    ...
    description:
      "Variedad de niñoneras y funcionales para el día a día o para viajes.",
  },
  {
    icon: Backpack,
    title: "Otros",
...
export default function Navbar() {
  ...
  return (
    <header className="m-0 bg-azul text-white p-4 flex justify-around items-center fixed z-50 w-full top-0 left-0">
      <Link href="/" passHref>
        <Image src={"/logo.png"} width={80} height={80} alt="Logo de kert" />
      </Link>
            ...
            >
              ...
              >
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <SecondaryLink href="/contacto" onClick={handleLinkClick}>
                    Contacto
                  </SecondaryLink>
                </div>
              </motion.div>
    ...
    return (
      <li className="hover:bg-[#05004c] p-2 rounded-md">
        <NavigationMenuLink asChild>
          <a ref={ref} className={("flex  gap-5", className)} {...props}>
            <div className="flex gap-5">
              <div className="flex justify-start items-center w-12 h-12">
                {Icon && <Icon className="w-6 h-6 text-amarillo" />}{" "}
                {/* Icono a la izquierda */}
              </div>
              <div className="flex flex-col">
                <div className="text-sm  leading-none text-white font-bold">
                  {title}
                </div>
